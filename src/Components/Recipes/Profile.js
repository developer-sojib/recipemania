        ...
        <main className="col-md-9">
          <div className="col-md-12 d-md-flex profile">
            ...
            <div className="col-md-9 profile-details">
              <h5 className="m-0">
                <i className="icons fas fa-user"></i> Name
              </h5>
              <h5>
                <i className="icons fas fa-mars"></i> Gender
              </h5>
              <h5>
                <i className="icons fas fa-envelope"></i> Email
              </h5>
              <h5>
                <i className="icons fas fa-eye"></i> Profile Views
              </h5>
              <h5>
                <i className="icons fas fa-flag"></i> Country
              </h5>
              <h5>
                <i className="icons fas fa-hamburger"></i> No Recipes
              </h5>
              <h5>
                <i className="icons fas fa-calendar-alt"></i> Member Since
              </h5>
            </div>
          </div>
              ...
              <div className="row p-2">
                ...
                <div className="col-10">
                  ...
                  <h3>
                    ...
                    Quam laboriosam, est ex nemo reiciendis non repellat libero
                    magnam alias ratione.
                  </h3>
                </div>
            ...
            <Row xs={1} md={3} className="g-4">
              {Array.from({ length: 6 }).map((_, idx) => {
                return (
                  <Col>
                    <Card
                      style={{ border: 0, padding: "4px", fontFamily: "auto" }}
                    >
                      <Card.Img
                        variant="top"
                      ...
                      <Card.Body style={{ paddingLeft: 0 }}>
                        ...
                        <Card.Text style={{ color: "#9b9292" }}>
                          <p style={{ marginRight: "10px", display: "inline" }}>
                            {" "}
                            25min -
                          </p>{" "}
                          1-2 Portions
                      ...
                      <div className={styles.middle}>
                        <div className="card-btn">
                          <Button className="bg-transparent">
                            <i className="far fa-play-circle fs-1 fw-bolder"></i>
                          </Button>
                        </div>
                      </div>
                    </Card>
