...
const Community = ({ community }) => {
  const { name, photo, description, facebook, twitter, instagram, pinterest } =
    community;
  return (
        ...
        <div className=" text-center community">
          ...
          <div className="my-3">
            <a href={pinterest} target="_blank" rel="noreferrer">
              <PinterestIcon
                style={{ margin: "0 4px", color: "orange", fontSize: "27px" }}
              />
            </a>
            <a href={facebook} target="_blank" rel="noreferrer">
              <FacebookIcon
                style={{ margin: "0 4px", color: "blue", fontSize: "27px" }}
              />
            </a>
